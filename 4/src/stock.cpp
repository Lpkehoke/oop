...
void Stock::changeShelLife(const Date& d) noexcept {
    Stock::printHeader();
    std::size_t num = 0;
    for (auto& i : m_store) {
        if (i > d) {
    ...
    Stock::printFooter(num);
}

void Stock::printHeader() noexcept {
    std::cout << std::endl << "fam" << "\t\t\t" << "price" << "\t\t\t" << "quant" << "\t\t\t" << "num" << "\t\t\t" << "year" << "\t\t\t" << "month"<< "\t\t\t" << "day" << std::endl;
    std::cout << "---------------------------------------------------------------------------------------------------------------------------------------------------------" << std::endl;
}
